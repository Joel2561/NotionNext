const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    ...
    { title: 'Shoot for the moon, even if you miss, you will land among the stars. 向月亮进发，即便没有达到，你亦将置身群星之中。', url: 'https://yujiale.blog' },
  ...
  HEO_GROUP_ICONS: [
    {
      title_1: 'AfterEffect',
      img_1: '/images/heo/speaker.webp',
      color_1: '#989bf8',
      title_2: 'Sketch',
      img_2: '/images/heo/read.webp',
      color_2: '#ffffff'
    },
    {
      title_1: 'Docker',
      img_1: '/images/heo/write.webp',
      color_1: '#57b6e6',
      title_2: 'Photoshop',
      img_2: '/images/heo/talk.webp',
      color_2: '#4082c3'
    },
    {
      title_1: 'FinalCutPro',
